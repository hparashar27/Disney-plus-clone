...
import { selectorUsername,selectorUseremail,selectorUserphoto, setUserLoginDetails ,setUserSignout} from '../features/Users/UserSlice';
...
return (
    ...
    {
      !username ? <Log onClick={HandleAuth}>LOGIN</Log> :
      <>
        <NavMenu>
          <a href="/home">
